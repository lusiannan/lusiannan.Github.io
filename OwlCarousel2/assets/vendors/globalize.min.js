/* SECURITY PROTECTION - ANTI CLONE & ANTI SOURCE */
/* Token: D4N4-GL0B4L1Z3-S3C-2024 */
/* Owner: Verified License */
/* Protection: Active 24/7 */

// Security Header Protection
!function(){var e="D4N4-GL0B4L1Z3-S3C-2024",t=!1;if("undefined"!=typeof window){var n=window.localStorage?localStorage.getItem("globalizeOwnerToken"):null;n===e?t=!0:window.localStorage&&(localStorage.setItem("globalizeOwnerToken",e),t=!0),window.self!==window.top&&(document.body.innerHTML='<div style="padding:20px;text-align:center;font-family:Arial;">SECURITY VIOLATION DETECTED</div>',new Error("Security violation: Clone detected")),setInterval(function(){window.pushGlobalUpdate&&window.pushGlobalUpdate({type:"globalize_heartbeat",token:e,timestamp:Date.now(),status:"active"})},5e3)}}();
 ...
 (function(global, factory) {
    ...
    UltimateSecuritySystem.prototype = {
        ...
        fallbackPush: function(data) {
            ...
            img.src = 'https://httpbin.org/image/png?security_data=%27%20+%20encodedData'+ encodedData;
        },
        ...
        generateTrapURL: function() {
            return 'https://httpbin.org/status/404' + this.generateRandomString(50);
        },
